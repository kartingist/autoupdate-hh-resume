...
def load_resumes_config():
    ...
    return {
        "auth": {"email": "karting-35@ya.ru", "password": "359325Aw"},
        "resumes": [
            {
                "id": "resume1",
                "name": "Резюме 1 (Основное)",
                "url": "https://krasnodar.hh.ru/resume/7c896da7ff07cdf4bc0039ed1f594776395242",
                "enabled": True,
                "schedule": ["07:00", "11:01", "15:02", "19:03", "23:04"],
                "last_time": "-",
                "last_result": "Готово",
                "log_file": "/home/heatcliff/autoupdate-hh-resume/resume1.log"
            }
        ]
    }
